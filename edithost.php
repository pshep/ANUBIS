...
if (isset($_POST['delete']) && isset($_POST['savehostid'])) {
	...
	$delq = "DELETE FROM hosts WHERE id = '$id' LIMIT 1";
...
if (isset($_POST['savehostid']) && !isset($_POST['delete'])) {
	...
	if ($newname && $newname !== "" && $address && $address !== "") {
		$updq = "UPDATE hosts SET name = '$newname', address = '$address', port = '$port', mhash_desired = '$mhash' WHERE id = '$id' LIMIT 1";
		//echo "UPDQ: $updq <BR>";
...
global $gpucol;
 ...
 if ($socket != null)
 {
	...
	if ($thisstatus && $thisstatus !== "" && $socket) {
			$gpus = 0;
			$cpus = 0;
...
<form name=save action="edithost.php" method="post">
...
<table id="savetable" align=center>
    <thead>
        ...
        <tr>
        <td align=center><input type="text" name="macname" value="<?=$name?>"></td>
        <td align=center><input type="text" name="ipaddress" value="<?=$host?>"></td>
        <td align=center><input type="text" name="port" value="<?=$hostport?>"></td>
        <td align=center><input type="text" name="mhash" value="<?=$mhash?>"></td>
        </tr>
        <tr>
        <td colspan=4 align=center><input type=hidden name="savehostid" value="<?=$hostid?>"><input type="submit" value="Save" name="save"><input type="submit" value="Delete this host" name="delete"></td>
        </tr>
    </thead>
</table>
